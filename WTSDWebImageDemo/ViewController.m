...
- (IBAction)imageCache:(UIButton *)sender {
    NSURL* imagePath1 = [NSURL URLWithString:@"http://i4.cqnews.net/news/attachement/jpg/site82/2016-08-23/9143505007648195979.jpg"];
    NSURL* imagePath2 = [NSURL URLWithString:@"http://www.people.com.cn/mediafile/pic/20160830/95/17946987410935083075.jpg"];
    //图片缓存的基本代码，就是这么简单
